...
export default {
  ...
  methods: {
    ...
    hanleAdd() {
      this.$router.push({ path: "/information/system_msg_add" });
    },
    handleEdit(row) {
      this.editForm = this.func.deepClone(row);
      sessionStorage.setItem("_sysmsg", JSON.stringify(this.editForm));
      this.$router.push({ path: "/information/system_msg_modify" });
    }
  }
};
</script>
