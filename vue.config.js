...
module.exports = {
    baseUrl: IS_PROD ? process.env.VUE_APP_SRC || '/admin/' : '/', // 默认'/'，部署应用包时的基本 URL
    ...
    css: {
        ...
        loaderOptions: {
            sass: {
                // 向全局sass样式传入共享的全局变量
                data: `@import "~assets/scss/variables.scss";@import "~assets/scss/common.scss";@import "~assets/scss/reset.scss";$src: "${process.env.VUE_APP_SRC}";`
